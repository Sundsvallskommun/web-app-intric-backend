...
export class AdminApiKeyController {
  ...
  async getApiKey(@Req() req: RequestWithUser, @Param('id') id:string, @Res() response: Response<ApiKeyApiResponse>): Promise<Response<ApiKeyApiResponse>> {
    ...
    try {
        ...
        throw new HttpException(e.httpCode, e.message);
    }
  }
}
